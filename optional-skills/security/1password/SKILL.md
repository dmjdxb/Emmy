...
version: 1.0.0
author: arceus77-7, enhanced by Emmy
license: MIT
...
- `tmux` available for stable authenticated sessions during Emmy terminal calls (desktop app flow only)
...
### Service Account (recommended for Emmy)
...
## Emmy Execution Pattern (desktop app flow)

Emmy terminal commands are non-interactive by default and can lose auth context between calls.
