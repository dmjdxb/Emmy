...
TIPS = [
    ...
    "Ctrl+Z suspends Emmy to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Emmy itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Emmy home directory.",
    ...
    "hermes gateway install sets up Emmy as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Emmy tools programmatically — results stay out of context.",
    ...
    "When exiting, Emmy prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Emmy runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Emmy via a local macOS server.",
    ...
    "Emmy loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Emmy as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Emmy your own.",
    ...
    "Before a gateway session reset, Emmy auto-flushes important facts to memory in the background.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Emmy auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Emmy config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Emmy is working.',
    ...
    'hermes dashboard embeds the full Emmy TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Emmy block commands when the tirith scanner itself errors out.',
