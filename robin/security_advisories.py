"""
Security advisory checker for Emmy.
...
run in environments where the rest of Emmy failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Emmy requires 3.10+ but defensive.
        return None
    try:
