...
def check_for_updates() -> Optional[int]:
    """Check whether a Emmy update is available.
...
def _resolve_repo_dir() -> Optional[Path]:
    """Return the active Emmy git checkout, or None if this isn't a git install.
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    Emmy checkout. Cached per-process. Release URL always points at the
...
def format_banner_version_label() -> str:
    ...
    base = f"Emmy v{VERSION} ({RELEASE_DATE})"
