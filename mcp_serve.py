"""
Emmy MCP Server — expose messaging conversations as MCP tools.
...
class EventBridge:
    ...
    This is the Emmy equivalent of OpenClaw's WebSocket gateway bridge.
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    """Create and return the Emmy MCP server with all tools registered."""
    ...
    mcp = FastMCP(
        "hermes",
        instructions=(
            "Emmy messaging bridge. Use these tools to interact with "
...
def run_mcp_server(verbose: bool = False) -> None:
    """Start the Emmy MCP server on stdio."""
    if not _MCP_SERVER_AVAILABLE:
        print(
