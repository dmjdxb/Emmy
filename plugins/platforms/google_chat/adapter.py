...
#     fresh "Emmy is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Emmy is thinking…".
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Emmy is thinking…' marker message.
        ...
        "Emmy is thinking…" stuck in chat forever, plus one card that
        ...
        body: Dict[str, Any] = {"text": "Emmy is thinking…"}
        if thread_id:
            body["thread"] = {"name": thread_id}
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Emmy is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Emmy is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Emmy is thinking…" card during any subsequent
...
def register(ctx) -> None:
    """Plugin entry point — called by the Emmy plugin system at startup.
    ...
    ctx.register_platform(
        ...
        # the "Emmy is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Emmy is thinking…' marker message "
