...
Invalid timezone values log a warning and fall back safely — Emmy never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Emmy requires 3.9+)
