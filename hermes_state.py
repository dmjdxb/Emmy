...
class SessionDB:
    ...
    def search_sessions_by_id(
        ...
        a session id from logs, CLI output, or another Emmy surface and jump
    ...
    def apply_telegram_topic_migration(self) -> None:
        ...
        reconciliation. Operators must be able to upgrade Emmy, keep the old
    ...
    def bind_telegram_topic(
        ...
        *,
        ...
        """Bind one Telegram DM topic thread to one Emmy session.

        A Emmy session may only be linked to one Telegram topic in MVP.
    ...
    def is_telegram_session_linked_to_topic(self, *, session_id: str) -> bool:
        """Return True if a Emmy session is already bound to any Telegram DM topic.
