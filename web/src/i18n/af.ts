...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateHermes: "Werk Emmy op",
    updatingHermes: "Besig om Emmy op te werk…",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Emmy meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Emmy 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Emmy skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
