...
Browser-based dashboard for managing Emmy configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Emmy” — mixed case, no Mondwest, no `text-display` |
