...
SCIENTIFIC_RIGOR_GUIDANCE = (
    ...
    "a formal proof — if a formal proof checker (Lean) is available among your tools, prefer it for such "
    "claims. Search your tools for it when a claim genuinely warrants a proof; it is not loaded by default.\n"
