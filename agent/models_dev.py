...
# ---------------------------------------------------------------------------
# Provider ID mapping: Emmy ↔ models.dev
# ---------------------------------------------------------------------------

# Emmy provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → Emmy (built lazily)
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Emmy provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal Emmy agent traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Emmy provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve Emmy ID → models.dev ID
...
def get_model_info(
    ...
    Accepts Emmy or models.dev provider ID.  Tries exact match then
