...
The guard fires when a tool tries to write into another Emmy profile's
...
# ---------------------------------------------------------------------------
# Helpers — set up a fake Emmy root with two profiles, monkeypatch the
