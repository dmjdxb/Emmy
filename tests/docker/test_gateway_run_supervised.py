...
def test_supervised_gateway_stdout_reaches_docker_logs(
    ...
    a poor user experience: the iconic "Emmy Gateway Starting…"
    ...
    assert "⚕" in combined or "Emmy Gateway Starting" in combined, (
    ...
    assert "⚕" in file_contents or "Emmy Gateway Starting" in file_contents, (
